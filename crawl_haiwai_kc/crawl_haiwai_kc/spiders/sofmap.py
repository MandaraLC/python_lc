...
class SofmapSpider(scrapy.Spider):
    name = 'sofmap'
    allowed_domains = ['sofmap.com']
    ...
    def __init__(self, *args, **kwargs):
        ...
        super(SofmapSpider, self).__init__(*args, **kwargs)
        """
        获取命令行参数
        """
        # 加载必要参数
    ...
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(SofmapSpider, cls).from_crawler(
            crawler, *args, **kwargs)
    ...
    def parse(self, response):
        ...
        item = OutputItem()
        # # 商品名称
        goods_name = response.xpath('//main[@id="main"]/section[@class="infobox"]/h1/text()').extract()[1].strip()
        ...
        icon = response.xpath('//form[@id="basketDetail"]/div[@id="purchase_area"]//input[@name="cart_in_button"]/@value').extract_first()
